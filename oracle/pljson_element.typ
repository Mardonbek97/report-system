...
(
  ...
  */
  ...
  member function to_clob(spaces boolean default true, chars_per_line number default 0) return clob,
...
create or replace type body pljson_element as
  ...
  */
  ...
  member function is_date return boolean as
  begin
    return false;
  end;
  ...
  */
  ...
  member function to_clob(spaces boolean default true, chars_per_line number default 0) return clob as
  begin
    if (spaces is null) then
      return pljson_printer.pretty_print_any_clob(self, line_length => chars_per_line);
    else
      return pljson_printer.pretty_print_any_clob(self, spaces, line_length => chars_per_line);
    end if;
  end;

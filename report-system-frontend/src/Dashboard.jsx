...
const ADMIN_MENU = [
  {
    key: "users",
    label: "Users",
    icon: <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-4a4 4 0 110-8 4 4 0 010 8zm6 4a2 2 0 10-4 0m-8 0a2 2 0 10-4 0" /></svg>,
  },
  {
    key: "reports",
    label: "Reports",
    icon: <svg width="15" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 17v-2m3 2v-4m3 4v-6M4 6h16M4 10h16M4 14h8M5 20h14a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v14a1 1 0 001 1z" /></svg>,
  },
  {
    key: "generate",
  ...
  },
  {
    ...
    icon: <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 6h16M4 10h16M4 14h10M4 18h6" /></svg>,
  },
  {
    key: "schedule-logs",
